...
import 'package:pharmed_app/views/authentication/signup/signup_otp/signup_otp_controller.dart';
...
class SignupOtpView extends StatefulWidget {
  final String email;
  SignupOtpView({super.key, required this.email});
                ...
                children: [
                  ...
                  Obx(
                    () => CommonButton(
                      ...
                      onPressed: () {
                        controller.signUpOtp(widget.email, otp ?? '');
                      },
